...
#End Region
        ...
        Public Sub Test_CriticalPoints()
            Dim strDataFile As String = m_strRootFolder & "\AnimatTesting\TestData\UnitTests\DataAnalyzer\data.txt"
            ...
            oAnalysis.SaveData(m_strRootFolder & "\AnimatTesting\TestData\UnitTests\DataAnalyzer\X3_Analysis.txt")
            ...
            oAnalysis.SaveData(m_strRootFolder & "\AnimatTesting\TestData\UnitTests\DataAnalyzer\Sin_Analysis.txt")

        End Sub

        <TestMethod()> _
        Public Sub Test_Compare()
            Dim strDataFile As String = m_strRootFolder & "\AnimatTesting\TestData\UnitTests\DataAnalyzer\data1.txt"
            Dim strX3Template As String = m_strRootFolder & "\AnimatTesting\TestData\UnitTests\DataAnalyzer\X3_Analysis.txt"
            Dim strSinTemplate As String = m_strRootFolder & "\AnimatTesting\TestData\UnitTests\DataAnalyzer\Sin_Analysis.txt"
            Dim iColumn As Integer = 0
            Dim iStartIdx As Integer = -1
            Dim iEndIdx As Integer = -1
