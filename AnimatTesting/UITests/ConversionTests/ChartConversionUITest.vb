...
#Region "Methods"
            ...
            Public Sub Test_DeleteNodesBeforeOpenChart()
                ...
                aryMaxErrors.Add("A1", 0.005)
                aryMaxErrors.Add("A2", 0.005)
                aryMaxErrors.Add("A3", 0.005)
                aryMaxErrors.Add("A4", 0.005)
                aryMaxErrors.Add("A5", 0.005)
                aryMaxErrors.Add("A6", 0.005)
